...
class VCR extends FlxShader
{
  @:glFragmentSource('
    ...
    uniform float iTime;
    uniform bool vignetteOn = true;
    uniform bool perspectiveOn = true;
    uniform bool distortionOn = true;
    uniform bool scanlinesOn = true;
    uniform bool vignetteMoving = true;
   // uniform sampler2D noiseTex;
    uniform float glitchModifier = 0;
